package com.fine.cutmusic.service;



import com.fine.cutmusic.entity.MetaData;
import com.fine.cutmusic.util.Utils;
...
public class DumpService {
    ...
    public DumpService(File f) throws Exception {
        this.ncm_f = f;
    ...
    public String execute() throws Exception {
        ...
        if (meta.format.equals("flac")) {
            ...
            ID3v23Tag id3_tag = (ID3v23Tag) audio_file.getTag();
        ...
        String path;
        System.out.println("output file path: " +(path= output_music.getAbsolutePath()));
        ncm_fis.close();
        return path;
    }
